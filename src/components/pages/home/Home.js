...
export default function Home() {
  return (
    ...
    <ImageProfile />
    <NameTag/>
    <p className='main'>I am a Computer Science and Mathematics Double Degree Programme (DDP) student at the National University of Singapore (NUS) with 7 years of playing around with tech. In my spare time, I watch movies, read comics and read a good mix of mystery, adventure novels and take long hikes.
    <br/><br/>
